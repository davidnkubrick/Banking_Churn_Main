...
experiment_name = 'bank_churn_project_rf'
...
#%%
file_name = '' # ENTER CSV FILE NAME  HERE, INCLUDING .csv
...
def objective(trial):
    ...
    with mlflow.start_run(nested = True):
        ...
        mlflow.sklearn.log_model(classifier_obj,'model')
    return accuracy
...
if __name__ == '__main__':
    ...
    plt.savefig('figures/rf_param_importance.png')
    fig1.show()

    fig2 = optuna.visualization.plot_optimization_history(study)
    plt.savefig('figures/rf_optimization_history.png')
    fig2.show()